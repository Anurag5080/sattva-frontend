...
const Hero3 = () => {
    return (
        <div className='bg-black w-full h-screen relative flex justify-center items-center flex-col px-24'>
            <h2 className='text-5xl text-[#BEB634] font-bold font-stretch-expanded absolute top-20' style={{ fontFamily: 'samarkan, sans-serif' }}>!! A tradition of Excellence !!</h2>
            <div className='flex justify-center items-center w-full'>
                ...
                <div className='flex justify-center items-center flex-col gap-10 z-10 absolute w-[45%] h-2/4 right-70 top-70'>
                    ...
                    <button className='bg-[#836F25] text-white rounded-full px-20 py-4 text-xl cursor-pointer hover:text-black hover:font-bold duration-200 ease-in-out'>Discover More</button>
                </div>
            </div>
        </div>
    )
