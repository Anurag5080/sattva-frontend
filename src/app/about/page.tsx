    ...
    return (
        <div className='min-h-screen w-full pt-30'>
            <div className='relative w-full min-h-[86vh] bg-black flex items-center justify-center'>
                ...
                <div className='z-10 absolute text-white  h-full max-w-[50vw] left-[40%] flex items-center justify-center flex-col gap-10 px-20'>
                    <h1 className='text-[#BEB634] text-5xl font-bold text-center' style={{ fontFamily: 'samarkan, sans-serif' }}>!! A Tradition Of Excellence !!</h1>
                    <p className='text-white text-lg text-center leading-10 tracking-wide'>“At Our Store, we are dedicated to the art and science of attar production, drawing upon the rich history of Kannauj, a city renowned for its centuries-old tradition of fragrance crafting. Established in 2024 by Sattva Attar, our mission is to provide a luxurious selection of exquisite attars that not only captivate the senses but also honor the heritage of this ancient craft.”</p>
                    <button className='bg-[#836F25] text-white rounded-full px-20 py-4 text-xl cursor-pointer hover:text-black hover:font-bold duration-200 ease-in-out'>Subscribe us for more.</button>
                </div>
            </div>
            <div className='w-full h-full bg-[#836F25] flex items-center pt-20 flex-col gap-20'>
                <div id='#ourstory' className='bg-black h-[50vh] border-2 border-[#CDCB42] rounded-4xl flex max-w-5xl mx-auto'>
                    ...
                    <div className='flex justify-around items-center flex-col w-1/2 p-10'>
                        <h2 className='text-[#836F25] text-4xl font-bold' style={{ fontFamily: 'samarkan, sans-serif' }}>Our Story</h2>
                ...
                <div className='bg-black h-[50vh] border-2 border-[#CDCB42] rounded-4xl flex max-w-5xl mx-auto'>
                    <div className='flex justify-around items-center flex-col w-1/2 p-10'>
                        <h2 className='text-[#836F25] text-4xl font-bold' style={{ fontFamily: 'samarkan, sans-serif' }}>Our Misson</h2>
                ...
                <div className='bg-black border-2 border-[#CDCB42] rounded-4xl h-full flex max-w-5xl mx-auto flex-col items-center'>
                    <div className='flex justify-around items-center flex-col w-1/2 p-10 gap-5'>
                        <h2 id='#contactus' className='text-[#836F25] text-4xl font-bold' style={{ fontFamily: 'samarkan, sans-serif' }}>Contact us.</h2>
